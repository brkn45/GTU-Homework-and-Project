...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 */
			...
			StreetArray streetArray = new StreetArray(100);
			StreetArrayList streetArrayList = new StreetArrayList(100);
			StreetLinkedList streetLinkedList = new StreetLinkedList(100);
			StreetLDLinkedList streetLDLinkedList = new StreetLDLinkedList(100);
			
			
			// Every city of instance is working; 
			//!!!  You should open only one of the comment lines for City and test it. !!!
			//City city = new City(streetArray);
			//City city = new City(streetArrayList);
			//City city = new City(streetLinkedList);
			City city = new City(streetLDLinkedList);
