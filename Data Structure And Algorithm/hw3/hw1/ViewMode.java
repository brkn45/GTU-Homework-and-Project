...
public class ViewMode implements Mode {
	...
	private double ratioOfPlayground() {
		...
		for(i=0; i<city.getStreet().getBuildingCountSide1();i++) {
			if(city.getStreet().getBuildingS1(i) instanceof Playground) {
				sum = sum + city.getStreet().getBuildingS1(i).getLength();
				playgroundCount++;
				
			}
		}
		for(i=0; i<city.getStreet().getBuildingCountSide2();i++) {
			if(city.getStreet().getBuildingS2(i) instanceof Playground) {
				sum = sum + city.getStreet().getBuildingS2(i).getLength();
				playgroundCount++;
			}
		}
	...
	private int streetAccupied() {
		...
		for(i=0;i < city.getStreet().getBuildingCountSide1();i++) {
			...
			if(city.getStreet().getBuildingS1(i) instanceof House || city.getStreet().getBuildingS1(i) instanceof Market
						|| city.getStreet().getBuildingS1(i) instanceof Office) {
		...
		for(i=0;i<city.getStreet().getBuildingCountSide2();i++) {
			if(city.getStreet().getBuildingS2(i) instanceof House || city.getStreet().getBuildingS2(i) instanceof Market
					|| city.getStreet().getBuildingS2(i) instanceof Office) {
			sum = sum + city.getStreet().getBuildingS2(i).getLength();
	...
	public void printSilhouette() {
		...
		for(i=0;i < city.getStreet().getBuildingCountSide1();i++) {
			for(k=city.getStreet().getBuildingS1(i).getStartArea();k<city.getStreet().getBuildingS1(i).getEndArea();k++) {
				arr1[k] = city.getStreet().getBuildingS1(i).getHeight();
				
			}
		}
		for(i=0;i < city.getStreet().getBuildingCountSide2();i++) {
			for(k=city.getStreet().getBuildingS2(i).getStartArea();k<city.getStreet().getBuildingS2(i).getEndArea();k++) {
				arr2[k] = city.getStreet().getBuildingS2(i).getHeight();
			}
		}
