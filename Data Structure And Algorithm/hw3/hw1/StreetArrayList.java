 ...
 * Used to Simple ArrayList
 * @author berkan
 *
 */
public class StreetArrayList implements Street{
	private int lenght;
	//private int startX, startY, endX, endY;
	private ArrayList<Building>  buildingSide1, buildingSide2;
	 ...
	 * 
	 */
	public StreetArrayList(int lenght) {
		this.lenght = lenght;
		buildingSide1 = new ArrayList<Building>();
		buildingSide2 = new ArrayList<Building>();
	...
	public ArrayList<Building> getBuildingSide1() {
		return buildingSide1;
	}


	public void setBuildingSide1(ArrayList<Building> buildingSide1) {
		this.buildingSide1 = buildingSide1;
	}


	public ArrayList<Building> getBuildingSide2() {
		return buildingSide2;
	}


	public void setBuildingSide2(ArrayList<Building> buildingSide2) {
