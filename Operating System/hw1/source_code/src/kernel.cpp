...
// Integer'ı string'e çeviren fonksiyon
void myItoa(common::uint32_t num, char *str) {
    char buffer[50]; // Geçici buffer
    int i = 0;
    int isNegative = 0;
    ...
    str[j] = '\0'; // Sonlandırma karakteri ekle
}

void printfInt(common::uint32_t num){
    char str[100];
    myItoa(num,str);
    printf(str);
}
...
void initProcessPriotryStrategy(){
...
extern "C" void kernelMain(const void* multiboot_structure, uint32_t /*multiboot_magic*/)
{
    ...
    //Task task4(&gdt, initProcessPriotryStrategy);
   ...
   //taskManager.AddTask(&task2);
    ...
    DriverManager drvManager;
        ...
        drvManager.AddDriver(&keyboard);
            ...
            MouseDriver mouse(&interrupts, &mousehandler,&taskManager);
        #endif
