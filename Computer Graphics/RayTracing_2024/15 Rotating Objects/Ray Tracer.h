	...
	public:
		...
		private: System::Void RayTracer_KeyPress(System::Object^  sender, System::Windows::Forms::KeyPressEventArgs^  e)
		{
			...
			switch (e->KeyChar)
			{
				case 'a':
				{
					RayTracer::Text = "Key A is pressed : CW rotation around Y-axis                                                                                    ( X : W/S, Y : A/D, Z : Q/E )";
				...
				case 'd':
				{
					RayTracer::Text = "Key D is pressed : CCW rotation around Y-axis                                                                      ( X : W/S, Y : A/D, Z : Q/E )";
				...
				case 'w':
				{
					RayTracer::Text = "Key W is pressed : CW rotation around X-axis                                                                                   ( X : W/S, Y : A/D, Z : Q/E )";
				...
				case 's':
				{
					RayTracer::Text = "Key S is pressed : CCW rotation around X-axis                                                                       ( X : W/S, Y : A/D, Z : Q/E )";
				...
				case 'e':
				{
					RayTracer::Text = "Key E is pressed : CW rotation around Z-axis                                                                                    ( X : W/S, Y : A/D, Z : Q/E )";
				...
				case 'q':
				{
					RayTracer::Text = "Key Q is pressed : CCW rotation around Z-axis                                                                      ( X : W/S, Y : A/D, Z : Q/E )";
