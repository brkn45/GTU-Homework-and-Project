    ...
    namespace hardwarecommunication
    {
        ...
        class InterruptManager
        {
            ...
            public:
                ...
                void Activate();
                void Deactivate();
                myos::common::uint32_t getPidInterrupt();
                bool exitInterrupt(CPUState* cpustate);
                bool setWaitProcessForAllChild(CPUState* cpustate);
                CPUState* setOneProcess(CPUState* cpustate);
                int createProcess(CPUState* cpustate);
                CPUState* interruptExec(CPUState* cpustate);
                int quantaTime =0;
                int setPriortyIM(CPUState* cpustate);
                myos::common::uint32_t scheduleTask(CPUState* cpustate);
                myos::common::uint32_t lowerPriortytySchedule(myos::common::uint32_t esp);
        };
