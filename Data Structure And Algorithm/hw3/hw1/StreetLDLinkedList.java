 ...
 * Used to Simple Lazy Deletion LinkedList
 * @author berkan
 *
 */
public class StreetLDLinkedList  implements Street{
	private int lenght;
	//private int startX, startY, endX, endY;
	private LDLinkedList<Building>  buildingSide1, buildingSide2;
	 ...
	 * 
	 */
	public StreetLDLinkedList(int lenght) {
		this.lenght = lenght;
		buildingSide1 = new LDLinkedList<Building>();
		buildingSide2 = new LDLinkedList<Building>();
	...
	public LDLinkedList<Building> getBuildingSide1() {
		return buildingSide1;
	}


	public void setBuildingSide1(LDLinkedList<Building> buildingSide1) {
		this.buildingSide1 = buildingSide1;
	}


	public LDLinkedList<Building> getBuildingSide2() {
		return buildingSide2;
	}


	public void setBuildingSide2(LDLinkedList<Building> buildingSide2) {
